                            ...
                            <ul className="nav nav-pills flex-column" id='parentM'>
                                <li className="nav-item py-2">
                                    <a href="/home" className="nav-link text-white" aria-current="page">
                                        <i className='me-3'><FaTachometerAlt /></i>
                                        Dashboard
                                    </a>
                                </li>
                                ...
                                <li className="nav-item py-2">
                                    <a href='/form' className="nav-link text-white " aria-current="page">
                                        <i className='me-3'><FaEdit /></i>
                                        Add Course
                                    </a>
                                </li>

                                <li className="nav-item py-2">
                                    <a href='/addCourseDetail' className="nav-link text-white" aria-current="page">
                                        <i className='me-3'><FaEdit /></i>
                                        Add Course Details
                                    </a>
                                </li>
                                ...
                                <li className="nav-item py-2">
                                    <a href="/table" className="nav-link text-white ">
                                        <i className='me-3'><FaTable /></i>
                                        Course Detail
                                    </a>
                                </li>
