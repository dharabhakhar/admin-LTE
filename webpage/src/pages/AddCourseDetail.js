...
function AddCourseDetail() {
    ...
    const [select, setSelected] = useState(courseOption[0]);
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:5000/course/coursecontent', {
            ...
            .then(function (response) {
                ...
                if(response.data.status == "course content updated" || response.data.status == "Success"){
                    setModal(true);
                }else{
                    setModal(false);
                }
        ...
        <>
            ...
            <div className="main-section">
                    ...
                    <div className="container-fluid">
                        <div className="form-box">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="h4 bg-primary p-3 rounded-top-3 text-white">Add Course Detail</div>
                                <div className="form px-3">
                                    <div className="user-box">
                                        ...
                                        <select value={select} onChange={handleCourseId} className='mb-3 w-50 rounded'>
                                            <option value={null} id="option" className='text-center'>--- Select Course ---</option>
                                            {
                                    ...
                                    <input type="submit" className="fs-5 text-white bg-primary rounded py-1 px-5 mb-4 border-0" value="Add" />
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <Modal show={modal} onHide={handleClose}>
                    <Modal.Body>COURSE-DETAILS SUCCESSFULLY ADD</Modal.Body>
